...
#ifndef DPP_REGISTERS_H
#define DPP_REGISTERS_H
...
/**
 *
 * Write a value to a DPP_REGISTERS register. A 32 bit write is performed.
 * If the component is implemented in a smaller width, only the least
 * significant data is written.
 *
 * @param   BaseAddress is the base address of the DPP_REGISTERSdevice.
 ...
 * @note
 * C-style signature:
 * 	void DPP_REGISTERS_mWriteReg(u32 BaseAddress, unsigned RegOffset, u32 Data)
 *
 */
#define DPP_REGISTERS_mWriteReg(BaseAddress, RegOffset, Data) \
  	Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))

/**
 *
 * Read a value from a DPP_REGISTERS register. A 32 bit read is performed.
 * If the component is implemented in a smaller width, only the least
 * significant data is read from the register. The most significant data
 * will be read as 0.
 *
 * @param   BaseAddress is the base address of the DPP_REGISTERS device.
 * @param   RegOffset is the register offset from the base to write to.
 *
 ...
 * @note
 * C-style signature:
 * 	u32 DPP_REGISTERS_mReadReg(u32 BaseAddress, unsigned RegOffset)
 *
 */
#define DPP_REGISTERS_mReadReg(BaseAddress, RegOffset) \
 ...
 *
 * @param   baseaddr_p is the base address of the DPP_REGISTERS instance to be worked on.
 *
 * @return
 *
 ...
 *
 */
XStatus DPP_REGISTERS_Reg_SelfTest(void * baseaddr_p);

#endif // DPP_REGISTERS_H
